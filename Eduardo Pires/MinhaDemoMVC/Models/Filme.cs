...
namespace MinhaDemoMVC.Models
{
    public class Filme
    {
        ...
        [StringLength(60, MinimumLength = 3, ErrorMessage = "O titulo precisa ter entre 3 a 60 caracteres")]
        ...
        [StringLength(30, ErrorMessage = "Maximo de 30 caracteres"), Required(ErrorMessage ="O campo gênero é requerido")]

        public string Genero { get; set; }
        [Range(1,1000, ErrorMessage = "Valor de 1 a 1000")]
        [Required(ErrorMessage = "Preencha com o campo Valor")]
